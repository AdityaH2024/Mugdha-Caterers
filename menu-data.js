/* ============================================================
   MUGDHA CATERERS — Shared Menu Data
   File: menu-data.js
   Compiled from the official Mugdha Caterers menu card.
   Pure Vegetarian. No pricing — quotations shared on request.
   ============================================================ */
...
var MUGDHA_MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      'Rajma Masala', 'Veg Kolhapuri', 'Mix Veg', 'Aloo Gobi', 'Aloo Matar',
      'Bhendi Masala', 'Vangi Masala', 'Matki Usal', 'Batata Bhaji',
      'Aloo Palak', 'Saag Bhaji'
    ]
  },
  {
    id: 'dal',
  ...
  },
  {
    ...
    items: [
      ...
      'Khaman Dhokla', 'Mini Uttapam', 'Mini Masala Dosa'
    ]
  },
  {
    id: 'chaat',
  ...
  },
  {
    ...
    items: [
      ...
      'Gajar Halwa', 'Moong Dal Halwa', 'Rasgulla', 'Ras Malai', 'Shahi Tukda'
    ]
  },
  {
    id: 'ice-cream',
